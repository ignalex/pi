...
def KODI_JSON(com='play_current', kodi = 'http://192.168.1.153:8080'):
    ...
    command = kodi + commands[com] #with HTTP address
    if com.startswith('vol') and com != 'volume': 
        new = com.replace('vol','').replace('_','')
        commands['vol'] = kodi + "jsonrpc?request=%7B%22jsonrpc%22:%20%222.0%22%2C%20%22method%22:%20%22Application.SetVolume%22%2C%20%22params%22:%20%7B%22volume%22:%20"+new+"%7D%2C%20%22id%22:%201%7D"
        com = 'vol'
