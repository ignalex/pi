# -*- coding: utf-8 -*-
"""
control address music via JSON http interface
...
def kodi(com='play_current'):
    ...
    command = address + commands[com] #with HTTP address
    if com.startswith('vol') and com != 'volume': 
        new = com.replace('vol','').replace('_','')
        commands['vol'] = address + "jsonrpc?request=%7B%22jsonrpc%22:%20%222.0%22%2C%20%22method%22:%20%22Application.SetVolume%22%2C%20%22params%22:%20%7B%22volume%22:%20"+new+"%7D%2C%20%22id%22:%201%7D"
        com = 'vol'
