...
# -*- coding: utf-8 -*-
"""
Created on Wed Jul  3 10:59:11 2019
...
class SevenSegments(object): 
    ...
    def clock(self, seconds=10):
        clock(self.seg, seconds)

    def _show_message_vp(self, msg, delay=0.1):
        show_message_vp(self.device, msg, delay=0.1)
    
    def _show_message_alt(self, msg, delay=0.1):
        show_message_alt(self.device, msg, delay=0.1)
    
    def message(self, msg, delay=0.1): 
        self._show_message_vp(msg, delay)

    def brightness(self,intensity=15):
        "1 - ... - 15"
        self.seg.device.contrast(intensity * 16)
